// Heritage Page Strategic Section Three.js Background with Interactive Elements
import * as THREE from 'https://cdn.jsdelivr.net/npm/three@0.161.0/build/three.module.js';

class HeritageStrategicBackground {
    constructor() {
        this.container = document.getElementById('heritage-strategic-canvas-container');
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => {
        new HeritageStrategicBackground();
    });
} else {
    new HeritageStrategicBackground();
}

export default HeritageStrategicBackground;
